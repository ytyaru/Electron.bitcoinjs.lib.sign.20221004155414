...
contextBridge.exposeInMainWorld('ipc', {
    ...
    // bitcoinjs-lib
    decodeTxHex:async(txHex)=>await ipcRenderer.invoke('decodeTxHex', txHex), // => tx
    //signTx:async(tx, address)=>await ipcRenderer.invoke('signTx', tx, address), // => txHex
    //signTx:async(tx, address)=>await ipcRenderer.invoke('signTx', tx, address), // => txHex
    signTx:async(txHex, tx, address)=>await ipcRenderer.invoke('signTx', txHex, tx, address), // => txHex
})
